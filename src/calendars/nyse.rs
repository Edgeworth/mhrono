...
use crate::calendars::us_holidays::{
    AUGUST45_VICTORY_OVER_JAPAN, CHRISTMAS, CHRISTMAS_BEFORE1954, CHRISTMAS_EVE_BEFORE1993,
    CHRISTMAS_EVE_IN_OR_AFTER1993, CHRISTMAS_EVES_ADHOC, DAY_AFTER_CHRISTMAS_ADHOC,
    ...
    US_MEMORIAL_DAY_BEFORE1964, US_MEMORIAL_DAY1964TO1969, US_NATIONAL_DAYSOF_MOURNING,
    US_NEW_YEARS_DAY, US_PRESIDENTS_DAY, US_THANKSGIVING_DAY, US_THANKSGIVING_DAY_BEFORE1939,
    US_THANKSGIVING_DAY1939TO1941, US_VETERANS_DAY1934TO1953, US_WASHINGTONS_BIRTH_DAY_BEFORE1964,
    US_WASHINGTONS_BIRTH_DAY1964TO1970, WEATHER_SNOW_CLOSING,
